...
from Code.ThirdParty.recoxplainer_master.recoxplainer.utils.torch_utils import use_cuda
from Code.ThirdParty.recoxplainer_master.recoxplainer.data_reader.user_item_dict import UserItemDict
...
class ExplAutoencoderTorch(nn.Module):
    ...
    def fit(self, dataset_metadata):
        ...
        self.dataset = dataset_metadata._dataset_df
